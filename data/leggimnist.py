...
# Calcola il percorso assoluto della cartella 'data' (dove si trova leggimnist.py)
cartella_script = os.path.dirname(os.path.abspath(__file__))

# Unisce il percorso alla cartella MNIST in modo dinamico
filedir = os.path.join(cartella_script, 'MNIST') + '/'
